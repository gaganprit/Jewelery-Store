...
else
{
	...
	$updateuser = "UPDATE users SET name='$Name', surname='$Surname', username='$Username', password=AES_ENCRYPT('$Password','key'), email='$Email', address='$Address', tel='$Tel', ac_type='$Type', user_status='$Status' WHERE user_id='$userid'";
