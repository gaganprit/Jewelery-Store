...
?>
 ...
 var delmsg = confirm("Do you confirm to delete category <?php echo $id; ?>?"); 
 	...
 	if(delmsg==true)
 	{
		...
		location.href='delconfirm?type=cat&paginated=<?php echo $paginated;?>&id=<?php echo $id; ?>';	
	}
 	else
 	{
		alert('Category Deletion Cancelled');
		location.href='viewcategories';
...
<script>window.location.href='viewcategories';</script>
