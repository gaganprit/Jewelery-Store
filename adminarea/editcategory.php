...
<?php echo 'Hi, <strong><font color="red">' . strtoupper($admin) . '</font></strong> Good To See You Working! || <a href="logout"> Logout </a>'; ?>
...
<table border="0" cellpadding="1" cellspacing="0" width="100%">
  <tr>
    <td colspan="5" height="96">
		<form name="formRegister" method="post" action="confirmeditcategory" onSubmit="return submitForms()">
