...
<?php echo 'Hi, <strong>' . strtoupper($admin) . '</strong> Good To See You Working! || <a href="logout"> Logout </a>'; ?>
...
<table border="0" cellpadding="1" cellspacing="0" width="100%">
  <tr>
    <td colspan="5" height="96">
		<form name="formRegister" method="post" action="confirmedituser" onSubmit="return submitForms()" "return checkPw(this)">
        ...
        <tr>
            <td bgColor="c6d3ce">
			  ...
			  <tr bgColor="dee7e7">
                ...
                <tr bgColor="e7efef">
                  <td>Password</td>
                  <td><b><input type="password" maxlength="10" name="pw1" size="30" value="" onMouseOver="value=''"></b></td>
                </tr>
				<tr bgColor="e7efef">
                  <td>Re-Password</td>
                  <td><b><input type="password" maxlength="10" name="pw2" onchange="acceptY()" size="30"></b></td>
                </tr>
                <tr bgColor="e7efef">
                  <td>Email</td>
