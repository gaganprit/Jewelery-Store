...
<table border="0" cellpadding="1" cellspacing="0" width="100%">
  <tr>
    <td colspan="5" height="96">
		<form name="formRegister" method="post" action="confirmprod" enctype="multipart/form-data" onSubmit="return submitForms()">
        ...
        <tr>
            <td bgColor="c6d3ce">
              <table width="400" border="0">
                ...
                <tr bgColor="e7efef">
                  <td>Upload Photo</td>
                  <td><b><input type="file" name="Pimage" id="file"></b></td>
                  </tr>
