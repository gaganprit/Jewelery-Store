...
*/
        ...
        echo "<p><a href='viewcategories'>View All</a> | <b>View Page:</b> ";
        for ($i = 1; $i <= $total_pages; $i++)
        {
                echo "<a href='viewcategories-paginated?page=$i'>$i</a> ";
        }
        echo " | <a href='newcategory'>Enter New Category</a></p>";
        ...
        for ($i = $start; $i < $end; $i++)
        {
				...
				echo '<td><a href="editcategory?id=' . mysql_result($result, $i, 'mmenu_id') . '">Edit</a></td>';
				echo '<td><a href="deletecategory?paginated=yes&id=' . mysql_result($result, $i, 'mmenu_id') . '">Delete</a></td>';
				echo "</tr>";
        }
        // close table>
        echo "</table>"; 
