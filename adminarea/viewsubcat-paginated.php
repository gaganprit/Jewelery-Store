...
*/
        ...
        echo "<p><a href='viewsubcat'>View All</a> | <b>View Page:</b> ";
        for ($i = 1; $i <= $total_pages; $i++)
        {
                echo "<a href='viewsubcat-paginated?page=$i'>$i</a> ";
        }
        echo " | <a href='newsubcat'>Enter New Sub Category</a></p>";
        ...
        for ($i = $start; $i < $end; $i++)
        {
				...
				echo '<td><a href="editsubcat?id=' . mysql_result($result, $i, 'id') . '">Edit</a></td>';
				echo '<td><a href="deletesubcat?paginated=yes&id=' . mysql_result($result, $i, 'id') . '">Delete</a></td>';
				echo "</tr>";
        }
        // close table>
        echo "</table>"; 
