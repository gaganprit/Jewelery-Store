...
<html>
<head>
	<title>Total Entry in cart</title>
	<style>
table {
			...
			<div class="box-content-1">
				<div class="box-product-1" >
						...
						else
						{
							...
							for($loop = 0; $loop < $rows; $loop++)
							{
								...
								while($row = mysqli_fetch_array($query, MYSQLI_ASSOC))
								{
									...
									$list .='<td><form method="post" action="updateqty"><input type="hidden" size="4" name="txtjewelid" value="' . $jewelid .'" /><input type="submit" value="+1" /></form></td>';
									$list .='<td><form method="post" action="removeqty"><input type="hidden" size="4" name="txtjewelid" value="' . $jewelid .'" /><input type="submit" value="-1" name="submit" /></form></td>';
									$list  .='<td>' . $dateadd . '</td>';
									$list .='<td><form method="post" action="remove"><input type="hidden" size="4" name="txtjewelid" value="' . $jewelid .'" /><input type="submit" value="X" name="submit" /></form></td></tr>';
					...
					<?php
					 ...
					 {
					?>
					<p align="center"><input type="button" value="Checkout" onClick="javascript:location.href='checkout';"></p>
					<?php
					 }
					?>
				</div>
