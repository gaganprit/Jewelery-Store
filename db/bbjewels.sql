...
CREATE TABLE IF NOT EXISTS `contact` (
  `cid` int(15) unsigned zerofill NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`cid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Customer Contact Form' AUTO_INCREMENT=21 ;
...
CREATE TABLE IF NOT EXISTS `jewellery` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci PACK_KEYS=0 AUTO_INCREMENT=328 ;
...
(0001, 'Diamond/Bangles/1.jpg', 'Diamond/Bangles/1.jpg', 1, '1000.00', 'Diamond Carte:20', 'old', 14, 33),
...
(0040, 'Diamond/Necklaces/5.jpg', 'Diamond/Necklaces/5.jpg', 3, '1000.00', 'Diamond Carte:13', 'featured', 1, 0),
...
(0059, 'Diamond/Pendant Set/6.jpg', 'Diamond/Pendant Set/6.jpg', 6, '375.00', 'Diamond Carte:30', 'featured', 1, 0),
(0060, 'Diamond/Pendant Set/7.jpg', 'Diamond/Pendant Set/7.jpg', 6, '2500.00', 'Diamond Carte:15', 'featured', 0, 0),
(0061, 'Diamond/Pendant Set/8.jpg', 'Diamond/Pendant Set/8.jpg', 6, '2500.00', 'Diamond Carte:17', 'featured', 2, 0),
...
(0071, 'Diamond/Pendants/10.jpg', 'Diamond/Pendants/10.jpg', 7, '2500.00', 'Diamond Carte:25', 'featured', 1, 0),
...
(0083, 'Gold/Bangles/4.jpg', 'Gold/Bangles/4.jpg', 9, '1000.00', 'Gold Carte:24', 'featured', 4, 0),
(0082, 'Gold/Bangles/3.jpg', 'Gold/Bangles/3.jpg', 9, '1000.00', 'Gold Carte: 24', 'featured', 5, 0),
(0086, 'Gold/Bangles/7.jpg', 'Gold/Bangles/7.jpg', 9, '1000.00', 'Gold Carte: 24', 'featured', 2, 0),
...
(0096, 'Gold/Ear Rings/7.jpg', 'Gold/Ear Rings/7.jpg', 10, '1000.00', 'Gold Carte:24', 'featured', 1, 0),
...
(0108, 'Gold/Lady Rings/9.jpg', 'Gold/Lady Rings/9.jpg', 35, '1000.00', 'Gold Carte:24', 'featured', 1, 0),
(0109, 'Gold/Lady Rings/10.jpg', 'Gold/Lady Rings/10.jpg', 35, '1000.00', 'Gold Carte:24', 'soon', 0, 0),
(0110, 'Gold/Man Rings/1.jpg', 'Gold/Man Rings/1.jpg', 36, '500.00', 'Gold Carte:24', 'featured', 1, 0),
...
(0117, 'Gold/Man Rings/8.jpg', 'Gold/Man Rings/8.jpg', 36, '1000.00', 'Gold Carte:24', 'featured', 1, 0),
(0118, 'Gold/Mang Tika/1.jpg', 'Gold/Mang Tika/1.jpg', 11, '1000.00', '1 Gram', 'featured', 1, 0),
(0119, 'Gold/Mang Tika/2.jpg', 'Gold/Mang Tika/2.jpg', 11, '2500.00', '1 Gram', 'featured', 1, 0),
...
(0139, 'Gold/Necklaces/2.jpg', 'Gold/Necklaces/2.jpg', 13, '2500.00', 'Gold Carte:24', 'featured', 1, 0),
...
(0183, 'Gold/Lady Rings/8.jpg', 'Gold/Lady Rings/8.jpg', 35, '2500.00', 'White Gold Carte:24', 'featured', 1, 0),
(0184, 'Gold/Lady Rings/9.jpg', 'Gold/Lady Rings/9.jpg', 35, '2500.00', 'Gold Carte: 24', 'featured', 1, 0),
...
(0232, 'Silver/Chain/8.jpg', 'Silver/Chain/8.jpg', 28, '1000.00', 'Pure Silver', 'featured', 1, 0),
...
(0260, 'Silver/Hair Pin/6.jpg', 'Silver/Hair Pin/6.jpg', 25, '1799.00', 'Silver', 'featured', 1, 0),
...
(0264, 'Silver/Hair Pin/10.jpg', 'Silver/Hair Pin/10.jpg', 25, '1000.00', 'Silver', 'featured', 1, 0),
...
(0269, 'Silver/Lady Rings/5.jpg', 'Silver/Lady Rings/5.jpg', 32, '2500.00', 'Pure Silver', 'featured', 1, 0),
...
(0319, 'Silver/Brooches/5.jpg', 'Silver/Brooches/5.jpg', 24, '500.00', 'Silver', 'featured', 2, 0),
...
(0327, 'Jewellery', '../Photos/Diamond/Necklaces/Heart-Shaped-Locket-Yellow-Gold.jpg', 0, '690.00', 'It''s an imported product', 'Mordern', 10, 0);
...
(0001, 5, 'Bangles', 'viewproduct'),
(0002, 5, 'EarRings', 'viewproduct'),
(0003, 5, 'Necklaces', 'viewproduct'),
(0004, 5, 'Nose Pin', 'viewproduct'),
(0005, 5, 'Pendant Set', 'viewproduct'),
(0006, 5, 'Pendants', 'viewproduct'),
(0007, 5, 'LadyRings', 'viewproduct'),
(0008, 3, 'Bangles', 'viewproduct'),
(0009, 3, 'Ear Rings', 'viewproduct'),
(0010, 3, 'Mang Tika', 'viewproduct'),
(0011, 3, 'Mangalsutra', 'viewproduct'),
(0012, 3, 'Necklaces', 'viewproduct'),
(0013, 3, 'Nose Rings', 'viewproduct'),
(0014, 3, 'Pendant Set', 'viewproduct'),
(0015, 3, 'Pendants', 'viewproduct'),
(0016, 4, 'Anklets', 'viewproduct'),
(0017, 4, 'Armlets', 'viewproduct'),
(0018, 4, 'Bracelet', 'viewproduct'),
(0019, 4, 'Brooches', 'viewproduct'),
(0020, 4, 'Hair Pin', 'viewproduct'),
(0021, 4, 'EarRings', 'viewproduct'),
(0022, 4, 'Cuffilinks', 'viewproduct'),
(0023, 4, 'Chain', 'viewproduct'),
(0024, 4, 'ManRings', 'viewproduct'),
(0025, 4, 'Pendants', 'viewproduct'),
(0026, 4, 'Pendants Sets', 'viewproduct'),
(0027, 4, 'Lady Rings', 'viewproduct'),
(0028, 3, 'LadyRings', 'viewproduct'),
(0029, 3, 'ManRings', 'viewproduct'),
(0030, 4, 'ToeRings', 'viewproduct'),
(0031, 8, 'Views', 'topviewed'),
(0032, 8, 'Sellings', 'topsell');
...
(0001, 'Universal Jewellery', 'Online Store', 'admin', 'admin', 'admin@bbjewels.com', 'Dunlop', 54954491, 'Administrator', 0);
...
(0001, 'Universal Jewellery is an online store about selling jewelleries such as Gold, Silver and Diamond and is developed by Gaganpreet Kaur, 'about');
