...
<header id="headerWrapper">
	<div id="header">
		<div id="logo">
			<a href="index"><img src="image/logo.jpg" width="245" height="95" title="BB Jewellery Logo" alt="Our Logo" /></a>
		</div>
		<!-- Mini Cart Start-->
		<div id="cart">
			<div class="heading"><a href="cart"><span id="cart-total"><?php echo $countrows;?> item(s) - Rs <?php echo $totalamount;?></span></a></div>
		...
		<!-- Mini Cart End-->
			<?php
			// Display Username
			echo '<div id="welcome"> Welcome <b><font color="blue">' . $User . '</font></b> || <a href="logout">Log Out</a></div>';
			?>
	</div>
	</br></br>
