...
if (isset($_SESSION['user_id'])) { // check if session user_id is set
	...
	$userid = "Hello,Guest! :)"; // assign a null value to $userid
}
echo "User Name: " . $userid; //print it on screen.
?>

<?php
$_SESSION['code'] = rand(); // assign a random value to $_SESSION['code']
$code = $_SESSION['code']; // then assign the value to $code
echo "<br />User Id: " . $code; // print the value of $code
?>
...
<!-- Main Div Tag Start-->
	...
	<!--Middle Part End-->
		...
		<div class="box-heading-1"><span>New Available Items</span></div>
			<div class="box-content-1">
				<div class="box-product-1" align="center" >
					<?php
