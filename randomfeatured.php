<?php
	...
	$textline1 = "Please Refresh To View More Products";
		 ...
		 $list .='
		   <div class="proName">
			...
			<div class="cart">
				...
				$list .='<form method="post" action="view"><input type="hidden" name="txtid" value="'.$id.'"><input type="submit" value="Add to Cart" class="button"/></form>';
