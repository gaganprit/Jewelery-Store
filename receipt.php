...
<p align="right"><a href="index">Home</a> | <a href="logout">Logout</a></p>
...
<table border="0" width="auto">
	...
	<tr>
		...
		<td width="3%"><b>:</b></td>
		<td width="auto"> <?php echo strtoupper($name); ?>&nbsp;<?php echo strtoupper($surname); ?></td>
	</tr>
...
<?php
	...
	$sql = "SELECT COUNT(*) FROM cart , jewellery, users 
	WHERE cart.cust_id = $userid AND users.user_id = $userid 
	AND cart.checkout = 'y' AND jewellery.id = cart.jewel_id 
	AND cart.checkedon = '$today' AND cart.trans = '$code'";
...
<p>THANK YOU FOR CHOSING UNIVERSAL JEWELLERY</p>
