...
<body>
<form id="ajaxform" method="post" action="searchresult" onSubmit="return submitForms()">
<div id="search" style="text-align:center">
	<div id="closeLogin" style="text-align:right;">
    <a href="#">
    	<img src="image/close.jpg" width="10%" height="15%" id="btnClose" /></a>
	</div>
	
	<div id="inputDivLogin">
        <div id="LoginInput"><input type="text" placeholder="Search an item here" name="search" /></div>
    </div>
